      ...
      <Container className="justify-content-center mt-3" fluid>
        <Row className="align-items-center">
          <Col>
            ...
            <h5 className="text-muted text-center">I&apos;m a web developer who majored in ITWS from RPI in May of 2021.</h5>
          </Col>
          <Col className="d-flex justify-content-center" height={400}>
            <Image src="pfp.jpeg" fluid roundedCircle width={400} />
          </Col>
        </Row>
        <Container className="mt-3">
          <Card bg="light">
            ...
            <Card.Body>
              ...
              <Card.Text>
                I am a web developer, primarily working in the MERN stack,
                but also learning Rust+Wasm, as well as C# and .NET.
                My Github is available
                {" "}
              ...
              <Card.Text>
                ...
                {" "}
                <a href="https://intercultural.uncg.edu/wp-content/uploads/Neopronouns-Explained-UNCG-Intercultural-Engagement.pdf">neopronouns</a>
                .
              </Card.Text>
          ...
          <Card className="mt-3" bg="light">
            ...
            <Card.Body className="d-flex justify-content-center"><GitHubCalendar username="brookerose1312" /></Card.Body>
          </Card>
        </Container>
      </Container>
    </div>
